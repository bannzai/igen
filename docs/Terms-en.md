...
1. "Intellectual Property Rights" means copyrights, patent rights, utility model rights, design rights, trademark rights, and any other intellectual property rights (including the rights to acquire such rights or to apply for registration thereof).
1. "Content" means text, audio, music, images, videos, software, programs, code, and other information.
1. "Service Content" means Content that can be accessed through the Service.
1. "User" means a person who uses the Service.
1. "Service" means the service named 偉言 (igen; published in English as "Dear Socrates") provided by the Provider (including the service after any change to its name or content for any reason).
1. "Individual Terms" means documents published by the Provider in the App separately from the Terms, under names such as "guidelines," "policies," or "rules," relating to the Service.
1. "App" means the application and related software operated by the Provider through which the Service is provided.

## Article 2 (Agreement to the Terms)
1. By downloading the App and actually using the Service, the User is deemed to have given valid and irrevocable consent to the Terms, and may use the Service in accordance with the Terms.
2. The User shall use the Service in accordance with the provisions of the Terms.
3. If the User is a minor, the User shall use the Service only after obtaining the consent of a legal representative such as a person with parental authority (including consent to the Terms). If a minor uses the Service by falsely claiming to have such consent despite not having it, by falsely claiming to be an adult, or otherwise by using deceptive means to cause others to believe that the minor has legal capacity, the minor may not rescind any legal act relating to the Service. If a User who was a minor at the time of agreeing to the Terms uses the Service after reaching the age of majority, the User is deemed to have ratified all acts of use performed while a minor.
4. If there are Individual Terms for the Service, the User shall use the Service in accordance with the Individual Terms as well as the Terms.
...
1. The Service includes free Service Content and paid Service Content (the "Paid Services"). The User may use the Paid Services by paying to the Provider, through the payment method designated by the Provider, the usage fees separately determined by the Provider and displayed in the App. The Paid Services include those with a fixed term (subscriptions) and those consumed upon each purchase (consumable items such as consultation tickets).
2. The User shall use the Paid Services after confirming their content and usage fees, and by actually using the Paid Services, the User is deemed to have given valid and irrevocable consent to the content and usage fees of the Paid Services. For subscriptions, the User shall additionally confirm, and by actual use is deemed to have consented to, the period during which the Paid Service applies (the "Paid Contract Period") and the automatic renewal of the contract on the same conditions if the prescribed termination procedure is not completed by the end of the Paid Contract Period ("Automatic Renewal"). Consumable items such as consultation tickets have no Paid Contract Period and no Automatic Renewal.
...
2. Even if a paying User uninstalls the App during the Paid Contract Period, the Automatic Renewal of the Paid Service is not cancelled. Even in such a case, the Provider will not refund any usage fees or other money, and the paying User accepts this in advance without objection.
3. Consumable items may not be returned or cancelled after purchase, and due to the nature of the function, no refund will be made for unused items.
4. The Provider will not, under any circumstances, refund any usage fees or other money already received.

## Article 6 (Content)
1. The Provider grants the User a non-exclusive right to use the Service Content provided by the Provider, which right may not be transferred or sublicensed, solely for the purpose of using the Service.
2. The User shall not use the Service Content beyond the intended manner of use contemplated by the Service (including reproduction, transmission, reposting, and modification).
3. The rights to content that the User inputs into the Service, such as consultation text ("User Content"), belong to the User. The User grants the Provider a license to use the User Content to the extent necessary for providing the Service (including generating responses, storing history, and personalization) and for improving the quality of the Service.
4. Users are responsible for backing up their own User Content. The Provider is not obligated to back up User Content.

## Article 7 (Prohibited Acts)
In using the Service, the User shall not engage in any of the following acts or acts that the Provider determines to fall under any of the following.
...
1. When the Service cannot be operated due to computer or communication line failure, operational error, excessive concentration of access, unauthorized access, hacking, or the like
1. When the Service cannot be operated due to force majeure such as earthquake, lightning, fire, wind or flood damage, power outage, or other natural disasters
1. When the Provider otherwise determines that suspension or interruption is necessary
...
1. When there is no response for 30 days or more to inquiries or other communications from the Provider requesting a response
1. When the Provider otherwise determines that continued use of the Service is not appropriate

## Article 11 (User Responsibility)
1. The User shall use the Service at the User's own responsibility and shall bear all responsibility for all acts performed in the Service and their results.
2. If the Provider determines that the User is using the Service in violation of the Terms, the Provider will take measures that the Provider deems necessary and appropriate. However, the Provider is not obligated to prevent or correct such violations.
3. If the Provider directly or indirectly incurs any damage (including the burden of attorneys' fees) due to the User's use of the Service (including cases where the Provider receives a complaint from a third party arising from such use), the User shall immediately compensate the Provider in accordance with the Provider's demand.
...
8. Even in the case set forth in the proviso of the preceding paragraph, the Provider shall bear no liability for damage arising from special circumstances (including cases where the Provider or the User foresaw or could have foreseen the occurrence of the damage) among damage incurred by the User due to default or tort caused by the Provider's negligence (excluding gross negligence).
9. If the Provider compensates for damage incurred by the User due to default or tort caused by the Provider's negligence (excluding gross negligence), the amount of compensation shall be limited to the amount of damage directly and actually incurred by the User. If the User is a paying User, the amount shall be limited to the amount of usage fees received from the paying User in the month in which the damage occurred.
10. Any transactions, communications, or disputes arising between the User and a third party in connection with the Service or the App shall be resolved at the User's own responsibility.

## Article 13 (Handling of User Information)
The handling of Users' user information by the Provider shall be governed by the separate Privacy Policy, and the User consents to the Provider handling the User's user information in accordance with the Privacy Policy.

## Article 14 (Changes to the Terms)
1. The Provider may change the Terms and the Individual Terms when the Provider deems it necessary. When changing the Terms, the Provider will announce the effective date and content of the changed Terms by posting in the Service or the App or by other appropriate means. However, for changes that require the User's consent under laws and regulations, the Provider will obtain the User's consent by the method prescribed by the Provider.
2. The changed Terms and Individual Terms shall take effect when posted in an appropriate place within the Service or the App. By continuing to use the Service after changes to the Terms or the Individual Terms, the User is deemed to have given valid and irrevocable consent to the changed Terms and the applicable Individual Terms. Please refer to the latest version of the Terms and the applicable Individual Terms whenever you use the Service.
...
Even if any provision of the Terms or part thereof is determined to be invalid or unenforceable under the Consumer Contract Act of Japan or other laws and regulations, the remaining provisions of the Terms and the remaining part of any provision determined to be partially invalid or unenforceable shall continue in full force and effect.

## Article 18 (Governing Law and Jurisdiction)
1. The Terms shall be governed by the laws of Japan.
2. The Tokyo District Court shall have exclusive jurisdiction as the court of first instance over any and all disputes arising out of or relating to the Terms.
